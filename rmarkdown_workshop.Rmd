...
A quick example of what a possible article written in RMarkdown looks like is here: [https://github.com/aakosm/rmarkdown_workshop/blob/master/rmd_example/ex2.pdf](https://github.com/aakosm/rmarkdown_workshop/blob/master/rmd_example/ex2.pdf)
